...
internal static class Program
{
	private static int Main()
	{
		try
		{
			...
			ShouldSanitizeHeaderIdentifier();
	...
	private static void ShouldSanitizeHeaderIdentifier()
	{
		string[] lines = Rgb565HeaderBuilder.BuildHeaderLines("BlockSprite_grass-block", 16, 16, 1, "0x0000, ");
		AssertEqual("const unsigned short BlockSprite_grass_block[256] PROGMEM={", lines[8], "sanitized header declaration");
		AssertEqual("_16x16", Rgb565HeaderBuilder.SanitizeIdentifier("16x16"), "leading digit identifier");
	}
